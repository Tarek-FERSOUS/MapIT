const PERMISSIONS = [
  ...
  { key: "incident:status:update", module: "incidents", action: "status:update", description: "Change incident lifecycle status" },
  { key: "incident:assign", module: "incidents", action: "assign", description: "Assign or unassign incidents" },
